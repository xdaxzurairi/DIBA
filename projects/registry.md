# DIBA Project Registry
*Senarai semua projek Abam Zue + path memory masing-masing*

| Workspace / Folder | Path Memory Projek |
|---|---|
| `//10.0.36.127/webs/ruangniaga` | `//10.0.36.127/webs/ruangniaga/admin/memory_core/` |
...
```
| `path/workspace` | `path/ke/memory/projek/` |
```

Fail memory projek yang dicari (ikut urutan):
